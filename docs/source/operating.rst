...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/smmozahidulhaque-web/raspberrypitss  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=43469  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='smmozahidulhaque-web'  \-\-env DOCKERUSERNAME='neuralstackai'  \-\-env MQTTUSERNAME=''  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   VIPERHOST_PRODUCE=172.17.0.2, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=172.17.0.2, VIPERPORT_PREPROCESS=35387, VIPERHOST_PREPOCESS2=172.17.0.2, VIPERPORT_PREPROCESS2=36617, VIPERHOST_PREPOCESS_PGPT=172.17.0.2, VIPERPORT_PREPROCESS_PGPT=35037, VIPERHOST_ML=172.17.0.2, VIPERPORT_ML=44787, VIPERHOST_PREDCT=172.17.0.2, VIPERPORT_PREDICT=45535, HPDEHOST=172.17.0.2, HPDEPORT=35497, HPDEHOST_PREDICT=172.17.0.2, HPDEPORT_PREDICT=37441

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6070-tml-multi-agenticai-iot-3f10-ml_agenticai-a9b6,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-preprocess-900-tml-multi-agenticai-iot-3f10-ml_agenticai-a9b6,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-ml-9081-tml-multi-agenticai-iot-3f10-ml_agenticai-a9b6,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-predict-3432-tml-multi-agenticai-iot-3f10-ml_agenticai-a9b6,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-agenticai-4689-tml-multi-agenticai-iot-3f10-ml_agenticai-a9b6,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
